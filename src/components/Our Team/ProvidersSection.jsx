        ...
        >
          {sectionProvidersData.map((provider) => {
            return (
              ...
              >
                <div
                  className={`absolute inset-0 bg-black opacity-0 hover:opacity-100 transition-opacity duration-1000 text-white p-6 flex flex-col ${
                    numberOfColumns == 5 ? 'gap-1 px-3 py-4' : 'gap-4 p-6'
